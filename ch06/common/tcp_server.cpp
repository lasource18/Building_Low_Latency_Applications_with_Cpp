...
namespace Common {
    // Add and remove socket file descriptors to and from the EPOOL list
    ...
    // Check for new connections or dead connections and update containers that tracks the sockets
